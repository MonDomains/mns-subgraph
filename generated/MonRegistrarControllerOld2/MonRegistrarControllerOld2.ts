...
export class MonRegistrarControllerOld2 extends ethereum.SmartContract {
  static bind(address: Address): MonRegistrarControllerOld2 {
    return new MonRegistrarControllerOld2(
      "MonRegistrarControllerOld2",
      address,
    );
  }
