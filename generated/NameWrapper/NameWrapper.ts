...
export class NameWrapper extends ethereum.SmartContract {
  ...
  registerAndWrapMON2LD(
    ...
    let result = super.call(
      "registerAndWrapMON2LD",
      "registerAndWrapMON2LD(string,address,uint256,address,uint16):(uint256)",
      [
...
export class RegisterAndWrapMON2LDCall extends ethereum.Call {
  get inputs(): RegisterAndWrapMON2LDCall__Inputs {
    return new RegisterAndWrapMON2LDCall__Inputs(this);
  }

  get outputs(): RegisterAndWrapMON2LDCall__Outputs {
    return new RegisterAndWrapMON2LDCall__Outputs(this);
  }
}

export class RegisterAndWrapMON2LDCall__Inputs {
  _call: RegisterAndWrapMON2LDCall;

  constructor(call: RegisterAndWrapMON2LDCall) {
    this._call = call;
  }
...
export class RegisterAndWrapMON2LDCall__Outputs {
  _call: RegisterAndWrapMON2LDCall;
...
export class UnwrapMON2LDCall extends ethereum.Call {
  get inputs(): UnwrapMON2LDCall__Inputs {
    return new UnwrapMON2LDCall__Inputs(this);
  }

  get outputs(): UnwrapMON2LDCall__Outputs {
    return new UnwrapMON2LDCall__Outputs(this);
  }
}

export class UnwrapMON2LDCall__Inputs {
  _call: UnwrapMON2LDCall;

  constructor(call: UnwrapMON2LDCall) {
    this._call = call;
  }
...
export class UnwrapMON2LDCall__Outputs {
  _call: UnwrapMON2LDCall;
...
export class UpgradeMON2LDCall extends ethereum.Call {
  get inputs(): UpgradeMON2LDCall__Inputs {
    return new UpgradeMON2LDCall__Inputs(this);
  }

  get outputs(): UpgradeMON2LDCall__Outputs {
    return new UpgradeMON2LDCall__Outputs(this);
  }
}

export class UpgradeMON2LDCall__Inputs {
  _call: UpgradeMON2LDCall;

  constructor(call: UpgradeMON2LDCall) {
    this._call = call;
  }
...
export class UpgradeMON2LDCall__Outputs {
  _call: UpgradeMON2LDCall;
...
export class WrapMON2LDCall extends ethereum.Call {
  get inputs(): WrapMON2LDCall__Inputs {
    return new WrapMON2LDCall__Inputs(this);
  }

  get outputs(): WrapMON2LDCall__Outputs {
    return new WrapMON2LDCall__Outputs(this);
  }
}

export class WrapMON2LDCall__Inputs {
  _call: WrapMON2LDCall;

  constructor(call: WrapMON2LDCall) {
    this._call = call;
  }
...
export class WrapMON2LDCall__Outputs {
  _call: WrapMON2LDCall;
