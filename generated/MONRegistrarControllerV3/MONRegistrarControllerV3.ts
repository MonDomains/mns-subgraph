...
export class MONRegistrarControllerV3__rentPriceResultPriceStruct extends ethereum.Tuple {
  get base(): BigInt {
...
export class MONRegistrarControllerV3 extends ethereum.SmartContract {
  static bind(address: Address): MONRegistrarControllerV3 {
    return new MONRegistrarControllerV3("MONRegistrarControllerV3", address);
  }
  ...
  rentPrice(
    name: string,
    duration: BigInt,
  ): MONRegistrarControllerV3__rentPriceResultPriceStruct {
    let result = super.call(
      "rentPrice",
    ...
    return changetype<MONRegistrarControllerV3__rentPriceResultPriceStruct>(
      result[0].toTuple(),
    );
  }
  ...
  try_rentPrice(
    name: string,
    duration: BigInt,
  ): ethereum.CallResult<MONRegistrarControllerV3__rentPriceResultPriceStruct> {
    let result = super.tryCall(
      "rentPrice",
      "rentPrice(string,uint256):((uint256,uint256))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<MONRegistrarControllerV3__rentPriceResultPriceStruct>(
        value[0].toTuple(),
      ),
    );
  }
