...
export class MONRegistrarControllerV2__rentPriceResultPriceStruct extends ethereum.Tuple {
  get base(): BigInt {
...
export class MONRegistrarControllerV2 extends ethereum.SmartContract {
  static bind(address: Address): MONRegistrarControllerV2 {
    return new MONRegistrarControllerV2("MONRegistrarControllerV2", address);
  }
  ...
  makeCommitment(
    ...
    let result = super.call(
      "makeCommitment",
      "makeCommitment(string,address,uint256,address,bytes[],bool):(bytes32)",
      [
        ethereum.Value.fromString(name),
  ...
  rentPrice(
    name: string,
    duration: BigInt,
  ): MONRegistrarControllerV2__rentPriceResultPriceStruct {
    let result = super.call(
      "rentPrice",
    ...
    return changetype<MONRegistrarControllerV2__rentPriceResultPriceStruct>(
      result[0].toTuple(),
    );
  }
  ...
  try_rentPrice(
    name: string,
    duration: BigInt,
  ): ethereum.CallResult<MONRegistrarControllerV2__rentPriceResultPriceStruct> {
    let result = super.tryCall(
      "rentPrice",
      "rentPrice(string,uint256):((uint256,uint256))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<MONRegistrarControllerV2__rentPriceResultPriceStruct>(
        value[0].toTuple(),
      ),
    );
  }
